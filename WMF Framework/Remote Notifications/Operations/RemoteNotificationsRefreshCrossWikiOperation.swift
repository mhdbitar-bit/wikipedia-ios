...
class RemoteNotificationsRefreshCrossWikiGroupOperation: RemoteNotificationsOperation {
    ...
    private func crossWikiOperations() -> [RemoteNotificationsRefreshCrossWikiOperation] {
        ...
        return filteredCrossWikiProjects.map { RemoteNotificationsRefreshCrossWikiOperation(project: $0, apiController: self.apiController, modelController: self.modelController, needsCrossWikiSummary: false, fromRefresh: fromRefresh, fromCrossWikiOperation: true)}
    }
}
